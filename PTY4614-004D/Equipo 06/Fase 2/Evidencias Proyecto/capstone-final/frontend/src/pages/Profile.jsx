...
export default function Profile() {
  ...
  if (!user) {
    return <div className="text-center py-32 text-3xl text-gray-400">Usuario no encontrado</div>;
  }
          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-center gap-10">
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="mt-8 flex flex-wrap gap-6 justify-center lg:justify-start">
                {user.intention && (
                  <div className={`px-8 py-4 rounded-2xl bg-gradient-to-r ${intentionConfig[user.intention]?.gradient || 'from-gray-600 to-gray-700'} text-white font-bold shadow-xl`}>
