  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="bg-white/10 backdrop-blur-lg p-8 rounded-2xl shadow-2xl w-full max-w-md">
        <h2 className="text-3xl font-bold text-center mb-6 text-purple-300">Iniciar Sesión</h2>
        ...
        <p className="text-center mt-4 text-sm">
          ¿No tienes cuenta? <Link to="/register" className="text-purple-400 hover:underline">Regístrate</Link>
        </p>
      </div>
    </div>
  )
